...
NOTE: v2 rewrite added MSS / displacement / reclaim sequencing. These
tests target the v1 implementation and need to be re-authored against
the new sequence. Skipped at module level.
"""
